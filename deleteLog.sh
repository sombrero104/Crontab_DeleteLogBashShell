...
TARGET_FILE_SIZE=5
LIMIT_USAGE=30
TARGET_FILES=( "/usr/local/tomcat-worker/worker1/logs/catalina.*.log"
					 "/usr/local/tomcat-worker/worker1/logs/host-manager.*.log"
					 "/usr/local/tomcat-worker/worker1/logs/localhost.*.log"
					 "/usr/local/tomcat-worker/worker1/logs/localhost_access_log.*.txt"
					 "/usr/local/tomcat-worker/worker1/logs/manager.*.log"
					 "/usr/local/tomcat-worker/worker1/logs/manager.log.*"
					 )
